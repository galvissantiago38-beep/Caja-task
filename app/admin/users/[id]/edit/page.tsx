...
export default async function EditUserPage({
  ...
  return (
    <div className="max-w-2xl space-y-10">
        ...
        <div className="flex items-center gap-5 mt-6">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3">
              <h1 className="font-serif text-2xl sm:text-3xl text-stone-900 dark:text-stone-100">
      ...
      <form action={updateAction} className="space-y-8 border-t border-stone-200 dark:border-stone-800 pt-8">
        <div>
        ...
        <div>
          ...
          {eresTu && (
            <p className="text-xs text-stone-700 dark:text-stone-300 border border-stone-300 dark:border-stone-700 bg-stone-50 dark:bg-stone-900 px-3 py-2 mt-3">
      ...
      <form action={resetAction} className="space-y-6 border-t border-stone-200 dark:border-stone-800 pt-8">
        <div>
          <p className="text-[11px] uppercase tracking-[0.25em] text-stone-500 dark:text-stone-400 mb-3">
            Seguridad
          </p>
